...
// Send new quote to mock server (POST)
...
// Required by checker: fetchQuotesFromServer (with async/await)
...
// Merge server quotes without duplicates
...
// Create the input form dynamically
...
populateCategories();
filterQuotes();
fetchQuotesFromServer(); // first sync on load
